...
#' Runs the Simulation for Detecting Lymphoid and Myeloid DMCTS
#' 
#' This function performs the monote-carlo sampleing for the case patients using 
...
run_simulation = function(a, b,  mc = 10, n_dmcts = 1000, type = "lymphoid", spec = FALSE, n_samp = 100, seed = 215, DMCTs,  sample_controls_mixed, lymphoid_frac, myeloid_frac,sample_controls_tcells, sample_controls_monocytes)
{
  set.seed(seed)
  npar = length(a)
